<?php
	...
	*/
		...
		function draw_month($start, $end, $pred_day, $image_name, $table, $fontfile, $showmonth_text) {
		...
		if (preg_match('/grid/', $showmonth_text)) {
